...
import cn.cicoding.collection.ArrayUtil;
...
public class RandomUtil {
	...
	/**
	 * 返回一个有序列的uuid编码 前11位为时间(毫秒) 中间4位为主机特征码 剩下的保证其唯一性
	 *
	 * @return
	 */
	public static String squid() {
		...
		String result = str + Contant.IMAGE_PATH + s.substring(17, 18) + s.substring(19, 23) + s.substring(24);
